...
/*   Updated: 2018/03/19 22:35:33 by hbouillo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	ft_printf("\nProcess %d reported %s (%d) (lives: %d) as alive\n",
		process->id, champ->name, champ->id, champ->lives);
}
